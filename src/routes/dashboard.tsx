...
import { OnePromptMovie } from "@/components/one-prompt-movie";
import { Plus, Film, Trash2, Wand2 } from "lucide-react";
    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-6 py-12">
        <div className="mb-10">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold">Studio</h1>
        </div>

        <Tabs defaultValue="movie" className="w-full">
          <TabsList className="mb-6">
            <TabsTrigger value="movie"><Wand2 className="size-4 mr-2" /> One-Prompt Movie</TabsTrigger>
            <TabsTrigger value="projects"><Film className="size-4 mr-2" /> Projects</TabsTrigger>
          </TabsList>
              ...
              <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent className="bg-card/95 backdrop-blur border-border/60">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label>Logline</Label>
                      <Textarea value={form.logline} onChange={(e) => setForm({ ...form, logline: e.target.value })} placeholder="A young engineer wakes alone in an abandoned space station…" rows={3} />
                    </div>
